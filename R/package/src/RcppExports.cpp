...
// spatialSEIRInit
SEXP spatialSEIRInit(SEXP compMatDim, SEXP xDim, SEXP zDim, SEXP S0_, SEXP E0_, SEXP I0_, SEXP R0_, SEXP Sstar0, SEXP Estar0, SEXP Istar0, SEXP Rstar0, SEXP Sstar, SEXP Estar, SEXP Istar, SEXP Rstar, SEXP X_, SEXP Z_, SEXP DistMat_, SEXP rho_, SEXP beta_, SEXP p_ei_, SEXP p_ir_, SEXP p_rs_);
RcppExport SEXP spatialSEIR_spatialSEIRInit(SEXP compMatDimSEXP, SEXP xDimSEXP, SEXP zDimSEXP, SEXP S0_SEXP, SEXP E0_SEXP, SEXP I0_SEXP, SEXP R0_SEXP, SEXP Sstar0SEXP, SEXP Estar0SEXP, SEXP Istar0SEXP, SEXP Rstar0SEXP, SEXP SstarSEXP, SEXP EstarSEXP, SEXP IstarSEXP, SEXP RstarSEXP, SEXP X_SEXP, SEXP Z_SEXP, SEXP DistMat_SEXP, SEXP rho_SEXP, SEXP beta_SEXP, SEXP p_ei_SEXP, SEXP p_ir_SEXP, SEXP p_rs_SEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        SEXP __result = spatialSEIRInit(compMatDim, xDim, zDim, S0_, E0_, I0_, R0_, Sstar0, Estar0, Istar0, Rstar0, Sstar, Estar, Istar, Rstar, X_, Z_, DistMat_, rho_, beta_, p_ei_, p_ir_, p_rs_);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
