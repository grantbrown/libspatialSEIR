...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        SEXP __result = spatialSEIRInit(compMatDim, xDim, zDim, S0_, E0_, I0_, R0_, Sstar0, Estar0, Istar0, Rstar0, Sstar, Estar, Istar, Rstar, X_, Z_, DistMat_, rho_, gamma_, priorAlpha_gamma_, priorBeta_gamma_, beta_, p_ei_, p_ir_, p_rs_, N_, outFile, logVarList, iterationStride, verboseFlag, debugFlag);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
