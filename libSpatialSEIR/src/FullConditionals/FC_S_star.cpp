...
namespace SpatialSEIR
{
                         ...
                         double _sliceWidth)
    {
       ...
       *sliceWidth = _sliceWidth;
        ...
        samplers -> push_back(new IndexedCompartmentBinomialMetropolisSampler(*context, this, (*S_star) -> data, 
                                                                      (*R) -> data, 
                                                                      (*S) -> data, 
                                                                      *p_rs, *((*context) -> S_star -> nrow)));
        samplers -> push_back(new CompartmentBinomialMixedSampler(*context, this, (*S_star) -> data, 
                                                                      (*R) -> data, 
                                                                      (*S) -> data, 
                                                                      *p_rs, *((*context) -> S_star -> nrow)));
        samplers -> push_back(new CompartmentBinomialSliceSampler(*context, this, (*S_star) -> data, 
                                                                      (*R) -> data, 
                                                                      (*S) -> data, 
                                                                      *p_rs, *((*context) -> S_star -> nrow)));
    ...
    int FC_S_Star::calculateRelevantCompartments(int i, int j)
    {
        (*context) -> calculateS_CPU(i, j);
        (*context) -> calculateR_givenS_CPU(i, j);
        return(0);
    }
