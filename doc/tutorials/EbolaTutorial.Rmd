...
# Fixed Co-variates
X = cbind(1, standard(pop.dens.km2), standard(area.km2), standard(GDP.pc))
# Time Varying co-variates
daysSinceJan = as.numeric(rptDate - as.Date("2014-01-01"))
Z = cbind(standard(daysSinceJan/365),            # linear term for time
          standard(daysSinceJan^2),               # quadratic term for time
          standard(daysSinceJan^3))               # cubic term for time
...
steadyStateConstraintPrecision = 0.00000001
