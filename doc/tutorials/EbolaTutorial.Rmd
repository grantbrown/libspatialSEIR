...
Now let's record the population sizes, densities, and GDP per capita as covariates. This information was obtained from wikipedia. 
...
area.km2 = c(245857, 111369, 71740)
GDP.pc = c(1082 , 672, 1344)
# Fixed Co-variates
X = cbind(1, pop.dens.km2, area.km2, GDP.pc)
# Time Varying co-variates
daysSinceJan = as.numeric(rptDate - as.Date("2014-01-01"))
Z = cbind(daysSinceJan/365,            # linear term for time
          daysSinceJan^2,               # quadratic term for time
          daysSinceJan^3)               # cubic term for time
...
for (i in 1:10)
{
  tm = tm + system.time(SEIRmodel$simulate(1000000))[3]
