...
```
```{r, tidy=FALSE, echo=TRUE, fig.width=4, fig.height=4}
par(mfrow = c(2,1))
plotChain(chainDat$p_ei, "E to I Transition Probability")
plotChain(chainDat$p_ir, "I to R Transition Probability")
```
